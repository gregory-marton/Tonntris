...
The original plan (see "Goal Description" below) is substantially implemented and verified, and so are the eight rounds of follow-up work that came after it:
